...
// POST /api/parking/lock-slot - Temporarily lock slot during booking flow
router.post('/lock-slot', parkingController.lockSlot);
...
// POST /api/parking/unlock-slot - Release temporary slot lock
router.post('/unlock-slot', parkingController.unlockSlot);
